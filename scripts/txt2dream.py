...
def slerp(
    ...
    copied from: https://gist.github.com/karpathy/00103b0037c5aaea32fe1da1af553355"""
    v0 = v0.cpu().numpy()
    v1 = v1.cpu().numpy()
...
def main():
    ...
    end_code = torch.randn([1, opt.C, opt.H // opt.f, opt.W // opt.f], device=device)
    codes_t_space = np.linspace(0, 1, opt.n_samples * opt.n_iter)
    codes_counter = 0
                ...
                for n in trange(opt.n_iter, desc="Sampling"):
                    for prompts in tqdm(data, desc="data"):
                        ...
                        for _ in range(opt.n_samples):
                            ...
                            x_T.append(slerp(t, start_code, end_code))
                            codes_counter += 1
